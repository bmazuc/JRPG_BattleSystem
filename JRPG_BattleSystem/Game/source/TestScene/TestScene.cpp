...
void TestScene::CreateScene()
{
    ...
    MovingEntity* enemy = SpawnActor<MovingEntity>("MovingEnemy", glm::vec2(320, 240), 0, glm::vec2(1,1), "goblin");
    ...
    KillableEntity* followEnemy2 = SpawnActor<KillableEntity>("KillableEnemy", enemy, glm::vec2(-165, 0), 0, glm::vec2(1, 1), "goblin");
    ...
    RotatingEntity* rotatingEnemy = SpawnActor<RotatingEntity>("RotatingEnemy", glm::vec2(600, 440), 0, glm::vec2(1, 1), "goblin");
...
void TestScene::CreateUI()
{
    ...
    LoadSceneButton* mainMenuButton = CreateUIElement<LoadSceneButton>("MainMenuButton", glm::vec2(320, 390), 0, glm::vec2(1, 1));
